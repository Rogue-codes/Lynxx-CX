...
export default function About() {
  return (
    <div className="w-full px-5">
      <h2 className="text-white-primary text-5xl font-bold leading-[64px] text-center my-[8.5rem]">
        About Us
      </h2>

      <div className="flex gap-2">
        <div className="w-[49%] h-[37.1rem] border-2 p-2 rounded-2xl border-blue-100">
          <img
            src={futuristic}
        ...
        <div className="w-[50%]">
          <p className="text-[#FBFBFB] pl-7 text-lg leading-[30px] font-medium">
          ...
          <div className="flex items-center">
            ...
            <div>
              ...
              <p className="text-white-secondary text-md leading-6 font-normal">
                Total Trading Pairs
              </p>
            </div>
          </div>
